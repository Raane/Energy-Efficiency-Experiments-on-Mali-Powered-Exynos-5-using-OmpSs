...
The performance experiments run on the older Arndale Duo board show that it have worse performance with its ARM Cortex-A15 cores than the ORDOID-XU3.
The two high power cores on the Arndale board have lower performance than a low power and a high power processor on the ORDOID board.
